...
public class GUI extends javax.swing.JFrame {
    ...
    private void btnConnectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConnectActionPerformed
        ...
        try {
            ...
            final GameClient multiPlayer = new GameClient(pnlGameBoard1, messageLabel, "localhost", cross, ring, lblOpponentName, playerName1, PORT);
...
//         
    ...
    private void showProgress(final String menu) throws InterruptedException {
